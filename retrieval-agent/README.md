# LangGraph Retrieval Chat Bot

[![CI](https://github.com/aixolotl/accelerator/actions/workflows/unit-tests.yml/badge.svg)](https://github.com/aixolotl/accelerator/actions/workflows/unit-tests.yml)
